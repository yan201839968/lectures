...
training_dataset$class <- factor(training_dataset$class) #randomforest automatically knows if it is a regression or classification problem
...
*better than bagging model and gives higher accuracy, sensitivity and specificity*
...
*if features are correlated, another feature will take over even when most important feature is excluded > not to take x value of variable importance too seriously*
